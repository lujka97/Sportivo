...
public class TimeSlot {
    ...
    public String getStartTimeOfDayWithMinutes(){
        ...
        return String.format(Locale.GERMAN, "%02d", startsHour) + ":" + String.format(Locale.GERMAN, "%02d", startsMinutes) + ":00";
    }

    public String getEndTimeOfDayWithMinutes(){

        return String.format(Locale.GERMAN, "%02d", endsHour) + ":" + String.format(Locale.GERMAN,"%02d", endsMinutes) + ":00";
    }
